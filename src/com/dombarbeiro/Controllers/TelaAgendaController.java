...
import src.com.dombarbeiro.CalendarActivity;

import src.com.dombarbeiro.Configs.ConexaoBD;
import src.com.dombarbeiro.Models.Atendimento;
...
public class TelaAgendaController implements Initializable {
    ...
    private void carregarCardInfos(Atendimento atendimentoSelec, Text text){
        ...
        textCardCliente.setText(atendimentoSelec.getCliente().getNome());
    ...
    private void abrirTelaCadastroAtendimento(ActionEvent event){
        ...
        try {
            ...
            FXMLLoader telaCadastroAtendimento = new FXMLLoader(getClass().getResource("../Views/telaCadastroAtendimento.fxml"));
