...
import src.com.dombarbeiro.Configs.PasswordLabelCell;
...
public class TelaAdminUsuarioController implements Initializable{
    ...
    private void carregarTabela(ActionEvent event){
        ...
        if(mostrarSenha){
            Image image = new Image("src/com/dombarbeiro/imgs/icon-password-off.png");
            iconSenha.setImage(image);
            senhaCol.setCellFactory(param -> new PasswordLabelCell(true));
        }else{
            Image image = new Image("src/com/dombarbeiro/imgs/icon-password.png");
            iconSenha.setImage(image);
    ...
    private void mostrarSenha(){
        if(!mostrarSenha){
            try {
                ...
                FXMLLoader telaAutenticar = new FXMLLoader(getClass().getResource("../Views/telaAutenticar.fxml"));
    ...
    void abrirCadastroUsuario(ActionEvent event){
        ...
        try {
                ...
                FXMLLoader telaCadastroUsuario = new FXMLLoader(getClass().getResource("../Views/telaCadastroUsuario.fxml"));
